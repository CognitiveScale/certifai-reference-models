...
1\. Model train (e.g. logisticRegression)
 ...
 - a. Go to the use-case/model directory.  - `cd useCase/modelName` Example: `cd healthcare_disease_prediction/logisticRegression`
...
1.	Go to the useCase/all directory - `cd useCase/all` Example: `cd healthcare_disease_prediction/all`
